...
const SideBar = () => {
	const getStyles = ({ isActive }) => {
		const style =
			" flex items-center gap-3 px-2 py-1 rounded rounded-tr rounded-br border border-gray-500/50";
		return isActive
	...
	return (
		<>
			<aside className='fixed top-12 left-0 flex flex-col text-xl gap-3 w-[16%] p-3 h-[100vh] border-r border-gray-700'>
